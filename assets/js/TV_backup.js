var valX = document.getElementById("tempX");
...
var Earth = function Earth(el, data) {
  ...
  function init() {
    ...
    var _loop = function (i) {
      ...
      new TWEEN.Tween(newLine).to({
        currentPoint: 200
      }, 5000).delay(i * 350 + 1500).easing(TWEEN.Easing.Cubic.Out).onUpdate(function () {
  ...
  function render() {
    ...
    var txt = document.getElementById("tempX");
    // txt.value = rotation.x;
    target.x = txt.value;
