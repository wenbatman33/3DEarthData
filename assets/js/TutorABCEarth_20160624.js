var earthLights = THREE.ImageUtils.loadTexture('assets/img/earth_3.jpg'),
...
var API_line = "___data/consultant_point.json";
...
var _loop = function (i) {
  points.push(new setPoint(data[i].la, data[i].lon,2, i));

  if(i%2){
    var newLine = drawCurve(points[i-1].position, points[i].position);
